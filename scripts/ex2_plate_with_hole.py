...
subset_size = 31
ref_img = Path.cwd()/"out"/"demo-dicuq"/"cam0_frame0_field0.bmp"
def_img = [Path.cwd()/"out"/"demo-dicuq"/"cam0_frame1_field0.bmp",
           Path.cwd()/"out"/"demo-dicuq"/"cam0_frame2_field0.bmp",]

# create a directory for the the different outputs
output_path = Path.cwd() / "out" / "dic-res"
...
print(80*"=")
print(f"{dicdata.u.shape=}")
print(f"{dicdata.v.shape=}")
print(80*"=")
