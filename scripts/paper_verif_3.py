...
LOWRES_FIG_CAPTION = (
    ...
    "rabbit mesh with a constant analytic function shader at low resolution for "
    "verification case 3. $SS$ denotes pixel sub-sampling. The reference render "
    "is shown at the top, followed by the difference maps in descending $SS$ "
    "order, and the lowest-SS render at the bottom. The difference images are "
    "plotted in 8-bit grey levels  denoted by GL."
)
