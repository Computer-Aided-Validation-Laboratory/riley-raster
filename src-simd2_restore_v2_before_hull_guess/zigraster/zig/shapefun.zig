...
fn shapeFunctions4SIMD(v_xi: @Vector(8, f64), v_eta: @Vector(8, f64), 
    ...
    v_dNu[0] = v_m025 * v_1_m_eta; v_dNu[1] = v_025 * v_1_m_eta;
    v_dNu[2] = v_025 * v_1_p_eta;  v_dNu[3] = v_m025 * v_1_p_eta;

    v_dNv[0] = v_m025 * v_1_m_xi;  v_dNv[1] = v_m025 * v_1_p_xi;
    v_dNv[2] = v_025 * v_1_p_xi;   v_dNv[3] = v_025 * v_1_m_xi;
}
...
fn shapeFunctions8SIMD(v_xi: @Vector(8, f64), v_eta: @Vector(8, f64), 
    ...
    v_dNu[4] = -x * v_1_m_y; v_dNu[5] = v_05 * v_1_m_y2;
    v_dNu[6] = -x * v_1_p_y; v_dNu[7] = v_m05 * v_1_m_y2;

    v_dNv[0] = v_025 * v_1_m_x * (x + v_2y);
    v_dNv[1] = v_025 * v_1_p_x * (v_2y - x);
    v_dNv[2] = v_025 * v_1_p_x * (x + v_2y);
    v_dNv[3] = v_025 * v_1_m_x * (v_2y - x);
    v_dNv[4] = v_m05 * v_1_m_x2; v_dNv[5] = -y * v_1_p_x;
    v_dNv[6] = v_05 * v_1_m_x2;  v_dNv[7] = -y * v_1_m_x;
}
...
fn shapeFunctions9SIMD(v_xi: @Vector(8, f64), v_eta: @Vector(8, f64), 
    ...
    const v_phi = [3]@Vector(8, f64){ v_05 * x * x_m_1, v_1 - x * x, v_05 * x * x_p_1 };
    const v_psi = [3]@Vector(8, f64){ v_05 * y * y_m_1, v_1 - y * y, v_05 * y * y_p_1 };
