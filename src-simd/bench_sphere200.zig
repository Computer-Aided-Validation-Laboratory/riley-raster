...
pub fn main() !void {
    ...
    const out_dir_base = "out-simd-sphere200";
    ...
    try common.writeBenchmarkReport(allocator, io, "Sphere 200 Benchmark Results", out_dir_base, pixel_num, stats_list.items, max_name_len);
}
