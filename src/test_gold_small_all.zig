...
test "Gold Small Suite" {
    ...
    for (mesh_types) |mt| {
        try common.runTestInternal(allocator, io, "single", mt, 1.1, texture, pixel_num, interp_types, "gold-small", "data-small", TOLERANCE, .both);
        try common.runTestInternal(allocator, io, "full", mt, 1.0, texture, pixel_num, interp_types, "gold-small", "data-small", TOLERANCE, .both);
    }
