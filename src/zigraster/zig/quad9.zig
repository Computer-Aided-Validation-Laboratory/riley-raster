...
inline fn fillFlat(
    ...
    for (0..actual_fields) |ff| {
        var vs: f64 = 0.0;
        for (0..9) |i| vs += n_v[i] * f_vals[ff][i];
            ...
            switch (@TypeOf(shader)) {
                *const FlatShader => {
                    ...
                    for (0..actual_fields) |ff| {
                        ...
                        inline for (0..9) |ii| f_vals[ff][ii] = shader.field.elems[ff_off + ii];
                    }
                    ...
                    for (s_sy..s_ey) |yy| {
                        ...
                        for (s_sx..s_ex) |xx| {
                            ...
                            if (newton.solveInverse(N, txs, tys, nr.x, nr.y, nr.z, u, v, 
                                                    &u, &v)) {
                                var n_v: [9]f64 = undefined; 
                                var dNu: [9]f64 = undefined; 
                ...
                *const TexShader => {
                    ...
                    inline for (0..2) |cc| {
                        ...
                        inline for (0..9) |ii| uv_vals[cc][ii] = shader.uvs.elems[c_off + ii];
                    }
